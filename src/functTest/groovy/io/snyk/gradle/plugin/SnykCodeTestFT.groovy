...
class SnykCodeTestFT extends Specification {
    ...
    def "can successfully scan with Snyk Code Test"() {

        when:
        def result = GradleRunner.create()
            .withProjectDir(testProjectDir.root)
            .withArguments('snyk-code-test')
            .withPluginClasspath()
            .build()

        then:
        println result.output
        result.output.contains("[High] Path Traversal")
